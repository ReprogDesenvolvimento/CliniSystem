from app.gui.main_screen import *
...
class LoginScreen(ctk.CTk, BackLoginScreen):
    ...
    def mostrar_senha(self):
        ...
        if self.ver_senha.get() == 1:  # 1 significa que o checkbox está marcado
            if hasattr(self, 'pass_login_entry'):
                self.pass_login_entry.configure(show="")  # Mostra a senha
            if hasattr(self, 'pass_cadastro_entry'):
                self.pass_cadastro_entry.configure(show="")  # Mostra a senha
            if hasattr(self, 'confirma_senha_entry'):
                self.confirma_senha_entry.configure(show="")  # Mostra a senha
        else:
            if hasattr(self, 'pass_login_entry'):
                self.pass_login_entry.configure(show="*")  # Oculta a senha
            if hasattr(self, 'pass_cadastro_entry'):
                self.pass_cadastro_entry.configure(show="*")  # Oculta a senha
            if hasattr(self, 'confirma_senha_entry'):
                self.confirma_senha_entry.configure(show="*")  # Oculta a senha
    ...
    def tela_de_login(self):
        ...
        self.ver_senha = ctk.CTkCheckBox(self.frame_login, text="Clique para ver a senha", font=("Century Gothic bold", 12), corner_radius=20, command=self.mostrar_senha)
    ...
    def tela_de_cadastro(self):
        ...
        self.ver_senha = ctk.CTkCheckBox(self.frame_cadastro, text="Clique para ver a senha", font=("Century Gothic bold", 12), corner_radius=20, command=self.mostrar_senha)
